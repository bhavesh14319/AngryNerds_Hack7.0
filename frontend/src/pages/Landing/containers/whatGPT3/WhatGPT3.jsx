    ...
    <div className="gpt3__wgpt3 section__margin " id="wgpt3">
      <div className="gpt3__wgpt3-content">
        <div className="gpt3__wgpt3-content__what">
          ...
          <p style={{animationName:  'square-in-bottom-right',animationDuration: '2s'}}>What is Farm Easy?</p>
        </div>
        <div className="gpt3__wgpt3-content__answer" style={{animationName:  'square-in-bottom-right',animationDuration: '2s'}}>
      ...
      <div className="gpt3__wgpt3-features">
        <div className="gpt3__wgpt3-features__chatbots">
          ...
          <div className="gpt3__wgpt3-features__chatbots-desc" style={{animationName:  'circle-in-top-right',animationDuration: '2s'}}>
        ...
        <div className="gpt3__wgpt3-features__knowledgebase" >
          ...
          <div className="gpt3__wgpt3-features__knowledgebase-desc" style={{animationName:  'circle-in-top-right',animationDuration: '2s'}}>
        ...
        <div className="gpt3__wgpt3-features__education">
          ...
          <div className="gpt3__wgpt3-features__education-desc" style={{animationName:  'circle-in-top-right',animationDuration: '2s'}}>
